 ...
 * Retrieve files.
 */
export const filesReadFiles = <ThrowOnError extends boolean = false>(options?: Options<FilesReadFilesData, ThrowOnError>) => (options?.client ?? client).get<FilesReadFilesResponses, FilesReadFilesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/files/',
    ...options
});
 ...
 * Delete a file.
 */
export const filesDeleteFileEndpoint = <ThrowOnError extends boolean = false>(options: Options<FilesDeleteFileEndpointData, ThrowOnError>) => (options.client ?? client).delete<FilesDeleteFileEndpointResponses, FilesDeleteFileEndpointErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/files/{id}',
    ...options
});
 ...
 * Upload a new file.
 */
export const filesUploadFile = <ThrowOnError extends boolean = false>(options: Options<FilesUploadFileData, ThrowOnError>) => (options.client ?? client).post<FilesUploadFileResponses, FilesUploadFileErrors, ThrowOnError>({
 ...
 * Download a file.
 */
export const filesDownloadFile = <ThrowOnError extends boolean = false>(options: Options<FilesDownloadFileData, ThrowOnError>) => (options.client ?? client).get<FilesDownloadFileResponses, FilesDownloadFileErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const filesGetFileUrl = <ThrowOnError extends boolean = false>(options: Options<FilesGetFileUrlData, ThrowOnError>) => (options.client ?? client).get<FilesGetFileUrlResponses, FilesGetFileUrlErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
